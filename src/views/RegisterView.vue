  ...
  <div class="auth-page">
    ...
    <div class="auth-container animate-fade-in-up">
      <div class="auth-logo">
        ...
        <h1>PokéDex</h1>
        <p>Comienza tu viaje Pokémon</p>
      </div>

      <form class="auth-form glass" @submit.prevent="handleRegister">
        <h2>Crear Cuenta</h2>
        ...
        <div class="input-group">
          ...
          <input id="reg-username" type="text" class="input" placeholder="AshKetchum"
            v-model="username" required minlength="3" maxlength="30" />
        </div>

        <div class="input-group">
          <label for="reg-email">Correo Electrónico</label>
          <input id="reg-email" type="email" class="input" placeholder="entrenador@pokedex.com"
            v-model="email" required autocomplete="email" />
        </div>

        <div class="input-group">
          <label for="reg-password">Contraseña</label>
          <input id="reg-password" type="password" class="input" placeholder="Mín. 6 caracteres"
            v-model="password" required minlength="6" autocomplete="new-password" />
        </div>

        <button type="submit" class="btn btn-primary btn-lg" style="width:100%"
          :disabled="authStore.loading">
          {{ authStore.loading ? 'Creando cuenta...' : 'Empezar Viaje' }}
        </button>
...
.auth-form h2 { font-size: 1.5rem; margin-bottom: 0.25rem; }
